# Job Description: Java Spring Boot Technical Project Manager
...
- [Algorithm problem-solving techniques](../algorithm/algorithm-problem-solving-techniques.md)
- [best front-end framework for spring cloud](../cloud/best-front-end-framework-for-spring-cloud-to-create-dashboard.md)
- [Development Manager and a Technical Manager](development-vs-technical-manager.md)
- [Disadvantages of using oracle apex](../frontend/disadvantages-of-using-oracle-apex.md)
- [Java Spring Cloud Development Manager](../cloud/Java-Spring-Cloud-Development-Manager-job-description.md)
- [Java Spring Cloud development and production environment](../cloud/Java-Spring-Cloud-environments.md)
- [Java Spring Cloud Skills](../cloud/Java-Spring-Cloud-skills.md)
- [distributed system Support in spring boot cloud](../cloud/distributed-system-Support-in-spring-boot-cloud.md)  
- [Kendo UI and DevExtreme](../frontend/KendoUI-vs-DevExtreme.md)
- [Mastering microservices with Spring Cloud](../cloud/master-microservices-with-spring-cloud.md)
- [Oracle Application Express](../frontend/oracle-apex-main-features.md)
- [Java Spring Cloud development environments tools](../cloud/preparing-Java-Spring-Cloud-development-environments-tools.md)
- [Problem solving techniques](problem-solving-techniques.md)
- [Scrum Agile framework](Scrum-agile-framework.md)
- [Scrum Experiences](scrum-experiences.md)
- [Cloud native development principles with spring](../cloud/cloud-native-development-principles-with-spring.md)
- [Use Spring Cloud with Docker and kubernetes](../cloud/use-spring-cloud-with-docker-and-kubernetes.md)
  (articles/cloud-native-development-principles-with-spring.md)
- [Spring Boot Application Analysis and Design Plan](spring-boot-application-analysis-and-design-plan.md)
---
